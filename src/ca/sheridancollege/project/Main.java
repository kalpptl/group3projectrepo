...
Each player has distributed 5 cards
A random player starts the game
1. player asks another random player by a card
2. If that player has that card, give all those cards to this player
3. if the player doesnt have it, he says Go FISH and this player will draw a card from fishing pond
4. If any player has a set of 4 same ranked card, he can remove it from his deck and his/her score will increment by 1
